...
from misc import round_coin_value
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from data.btanalysis import load_backtest_stats
    from optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: Dict[str, Any]) -> None:
    ...
    try:
        ...
        from optimize.hyperopt import Hyperopt
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from optimize.edge_cli import EdgeCli
