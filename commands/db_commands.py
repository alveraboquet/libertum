...
from configuration.config_setup import setup_utils_configuration
...
def start_convert_db(args: Dict[str, Any]) -> None:
    ...
    from persistence import Order, Trade, init_db
    from persistence.migrations import set_sequence_ids
