...
from configuration import TimeRange, setup_utils_configuration
from data.converter import convert_ohlcv_format, convert_trades_format
from data.history import (convert_trades_to_ohlcv, refresh_backtest_ohlcv_data,
                                    refresh_backtest_trades_data)
from enums import CandleType, RunMode, TradingMode
from exceptions import OperationalException
from exchange import timeframe_to_minutes
from exchange.exchange import market_is_active
...
def start_list_data(args: Dict[str, Any]) -> None:
    ...
    from data.history.idatahandler import get_datahandler
