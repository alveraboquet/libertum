...
from enums import (CandleType, ExitCheckTuple, ExitType, SignalDirection, SignalTagType,
                             SignalType, TradingMode)
from enums.runmode import RunMode
from exceptions import OperationalException, StrategyError
from exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from persistence import Order, PairLocks, Trade
from strategy.hyper import HyperStrategyMixin
from strategy.informative_decorator import (InformativeData, PopulateIndicators,
...
class IStrategy(ABC, HyperStrategyMixin):
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float, rate: float,
        ...
        For full documentation please go to https://www.io/en/latest/strategy-advanced/
    ...
    def adjust_entry_price(self, trade: Trade, order: Optional[Order], pair: str,
        ...
        For full documentation please go to https://www.io/en/latest/strategy-callbacks/
