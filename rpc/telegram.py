...
from constants import DUST_PER_COIN
from enums import RPCMessageType, SignalDirection, TradingMode
from exceptions import OperationalException
from misc import chunks, plural, round_coin_value
...
class Telegram(RPCHandler):
    ...
    def _add_analyzed_candle(self, pair: str) -> str:
        ...
        if candle_val != 'off':
            if candle_val == 'ohlc':
                analyzed_df, _ = self._rpc._dataprovider.get_analyzed_dataframe(
    ...
    def _help(self, update: Update, context: CallbackContext) -> None:
        ...
        if self._rpc._trading_mode != TradingMode.SPOT:
    ...
    def _version(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        strategy_version = self._rpc._strategy.version()
    ...
    def _show_config(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        val = RPC._rpc_show_config(self._config, self._rpc._state)
