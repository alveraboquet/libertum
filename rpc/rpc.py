...
from configuration.timerange import TimeRange
from constants import CANCEL_REASON, DATETIME_PRINT_FORMAT
from data.history import load_data
from data.metrics import calculate_max_drawdown
from enums import (CandleType, ExitCheckTuple, ExitType, SignalDirection, State,
                   TradingMode)
from exceptions import ExchangeError, PricingError
from exchange import timeframe_to_minutes, timeframe_to_msecs
from loggers import bufferHandler
from misc import decimals_per_coin, shorten_date
from persistence import PairLocks, Trade
from persistence.models import PairLock
from plugins.pairlist.pairlist_helpers import expand_pairlist
from rpc.fiat_convert import CryptoToFiatConverter
from wallets import PositionWallet, Wallet
...
class RPC:
    ...
    def _rpc_count(self) -> Dict[str, float]:
        ...
        return {
            'current': len(trades),
            'max': (int(self._config['max_open_trades'])
                    if self._config['max_open_trades'] != float('inf') else -1),
    ...
    def _rpc_get_logs(limit: Optional[int]) -> Dict[str, Any]:
        ...
        #       "worker", "INFO", "Starting worker develop"]
    ...
    def _rpc_analysed_dataframe(self, pair: str, timeframe: str,
        ...
        return self._convert_dataframe_to_dict(self._config['strategy'],
    ...
    def _rpc_analysed_history_full(config, pair: str, timeframe: str,
        ...
        from resolvers.strategy_resolver import StrategyResolver
