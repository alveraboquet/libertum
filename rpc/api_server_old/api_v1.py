...
from enums import CandleType, TradingMode
from exceptions import OperationalException
from rpc import RPC
from rpc.api_server.api_schemas import (AvailablePairs, Balances, BlacklistPayload,
...
from rpc.api_server.deps import get_config, get_exchange, get_rpc, get_rpc_optional
...
def show_config(rpc: Optional[RPC] = Depends(get_rpc_optional), config=Depends(get_config)):
    ...
    if rpc:
        state = rpc._state
        strategy_version = rpc._strategy.version()
