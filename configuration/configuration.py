...
import constants
from configuration.check_exchange import check_exchange
from configuration.deprecated_settings import process_temporary_deprecated_settings
from configuration.directory_operations import create_datadir, create_userdata_dir
from configuration.environment_vars import enironment_vars_to_dict
from configuration.load_config import load_file, load_from_files
from enums import NON_UTIL_MODES, TRADING_MODES, CandleType, RunMode, TradingMode
from exceptions import OperationalException
from loggers import setup_logging
from misc import deep_merge_dicts, parse_db_uri_for_logging
    ...
    def _process_trading_options(self, config: Dict[str, Any]) -> None:
        ...
        if config.get('dry_run', False):
            ...
            if config.get('db_url') in [None, constants.DEFAULT_DB_PROD_URL]:
                ...
                config['db_url'] = constants.DATEWISE_DB_URL
        else:
