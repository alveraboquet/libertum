...
from constants import (DEFAULT_AMOUNT_RESERVE_PERCENT, NON_OPEN_EXCHANGE_STATES, BuySell,
...
from enums import OPTIMIZE_MODES, CandleType, MarginMode, TradingMode
from exceptions import (DDosProtection, ExchangeError, InsufficientFundsError,
...
from exchange.common import (API_FETCH_ORDER_RETRY_COUNT, BAD_EXCHANGES,
                                       ...
                                       retrier_async)
from misc import chunks, deep_merge_dicts, safe_value_fallback2
...
class Exchange:
    ...
    def market_is_tradable(self, market: Dict[str, Any]) -> bool:
        """
        Check if the market symbol is tradable by 
    ...
    def validate_timeframes(self, timeframe: Optional[str]) -> None:
        ...
        if timeframe and timeframe_to_minutes(timeframe) < 1:
            raise OperationalException("Timeframes < 1m are currently not supported by ")
